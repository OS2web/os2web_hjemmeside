...
class Os2webMetatagFirehose extends MetatagFirehose {
  ...
  public function settingsSummary() {
    ...
    if (!empty($hide_basic_elements)) {
      $summary[] = $this->t('Hidden elements: @elements',
        [
          '@elements' => implode(', ', $hide_basic_elements),
        ]);
    }
    ...
    $summary[] = $this->t('- required: @description_required',
      [
        '@description_required' => $this->getSetting('description_required') ? $this->t('Yes') : $this->t('No'),
      ]);
    return $summary;
  }
